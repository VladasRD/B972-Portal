...
{
    public class GerenciaNetEndpoints : DynamicObject
    {
        ...
        public GerenciaNetEndpoints(string clientId, string clientSecret, bool sandbox)
        {
            ClientId = clientId;
            ClientSecret = clientSecret;
            endpoints = JObject.Parse(File.ReadAllText("../endpoints.json"));
            HttpHelper = new HttpHelper();
            HttpHelper.BaseUrl = sandbox ? apiBaseSandboxURL : apiBaseURL;
        }

        public GerenciaNetEndpoints(string clientId, string clientSecret, bool sandbox, string partnerToken) : this(clientId, clientSecret, sandbox)
        {
            if (partnerToken != "")
