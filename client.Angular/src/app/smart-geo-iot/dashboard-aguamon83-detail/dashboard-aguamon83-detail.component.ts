...
export class DashboardAguamon83DetailComponent implements OnInit {
  ...
  private getDashboard(): void {
    ...
    this.sgiService.getDashboard(this._deviceId, _dateFilter != null ? _dateFilter.toJSON() : <string>null, this.seqNumber, this.navigation, 0, ProjectEnum.B982_S).subscribe(d => {
