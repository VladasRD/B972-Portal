...
@Component({
  selector: 'app-graphic-trm-detail',
  templateUrl: './graphic-trm-detail.component.html',
  styleUrls: ['./graphic-trm-detail.component.css']
})
export class GraphicTrmDetailComponent implements OnInit {
