...
@Component({
  selector: 'app-dashboard-b978-detail',
  templateUrl: './dashboard-b978-detail.component.html',
  styleUrls: ['./dashboard-b978-detail.component.css']
})
export class DashboardB978DetailComponent implements OnInit {
  ...
  private getDashboard(): void {
    ...
    this.sgiService.getDashboard(this._deviceId, _dateFilter != null ? _dateFilter.toJSON() : <string>null, this.seqNumber, this.navigation, 0, ProjectEnum.B978).subscribe(d => {
