...
@Component({
  selector: 'app-graphic-tsp-detail',
  templateUrl: './graphic-tsp-detail.component.html',
  styleUrls: ['./graphic-tsp-detail.component.css']
})
export class GraphicTspDetailComponent implements OnInit {
  ...
  public lineChartData: ChartDataSets[] = [{ data: [], label: 'Vazão m³' }];
  ...
  get pageTitle(): string {
    return String.Format('Gráfico do dispositivo {0} (TSP)', this._deviceId);
  }
