...
@Component({
  selector: 'app-dashboard-aguamon-detail',
  templateUrl: './dashboard-aguamon-detail.component.html',
  styleUrls: ['./dashboard-aguamon-detail.component.css']
})
export class DashboardAguamonDetailComponent implements OnInit {
