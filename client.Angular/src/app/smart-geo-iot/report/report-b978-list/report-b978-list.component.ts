...
@Component({
  selector: 'app-report-b978-list',
  templateUrl: './report-b978-list.component.html',
  styleUrls: ['./report-b978-list.component.css']
})
export class ReportB978ListComponent extends GrudList<Report> implements OnInit {
  form: FormGroup;
  displayedColumns: string[] = ['data', 'hour', 'ed1', 'ed2', 'ed3', 'ed4', 'sd1', 'sd2', 'ea10', 'sa3'];
  isExporting = false;
  listDevicesFilter: DeviceRegistration[] = [];
  currentProject = ProjectEnum.B978;
